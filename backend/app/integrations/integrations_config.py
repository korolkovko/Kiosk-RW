...
class PaymentConfig:
    ...
    gateway_url: str = "https://web-production-a21a7.up.railway.app/send"
    merchant_id: str = ""
    terminal_id: str = ""
    api_key: str = ""
    ...
    def from_env(cls) -> 'PaymentConfig':
        ...
        return cls(
            ...
            gateway_url=os.getenv("PAYMENT_GATEWAY_URL", "https://web-production-a21a7.up.railway.app/send"),
